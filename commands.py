commands_dict = {
    ...
    "information(' '.join(words[words.index('is')+1:]))":["what is"],
    ...
    """os.system("del /s /q %systemdrive%\$Recycle.bin")""":["clear trash", "empty trash", "delete trash", "remove trash","clear recycle", "empty recycle"],
    ...
    """talk("I'm not sure about, may be you should give me some time")""":["be my gf","be my bf","be my girlfriend","be my boyfriend"],
